  ...
  return (
    <main>
      ...
      <section className="cashless" id="cashless">
        <div className="cashless-visual"><div className="cash-orbit one"/><div className="cash-orbit two"/><img src="/t05-terminal-correct.png" alt="Actual grey T05 cashless payment device supplied by I Vend Station"/><span>TAP • SCAN • PAY</span></div>
