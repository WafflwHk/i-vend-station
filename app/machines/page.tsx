  ...
  return (
    <main className="collection-page">
      <section className="collection-hero">
        ...
        <div className="collection-hero-foot" data-animate="up" data-animate-delay="2"><p>Compare the current range, open any machine for a rotatable front, side, and rear view, then request the exact configuration.</p><span>{String(catalogueMachines.length).padStart(2, "0")} machine types</span></div>
      </section>
